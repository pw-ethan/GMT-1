...
all : main.o CryptoUtility.o common.o CtxtNode.o ZZNode.o CtxtSiblingPathNode.o Auth.o DSAuth.o VTree.o PTree.o Base64.o DBUtility.o Node.o #Talk2Svr.o#auth_ds.o crypto_fhe_utility.o p_tree.o p_list.o v_tree.o v_list.o#MyDB.o
