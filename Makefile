...
all : main.o common.o Base64.o DBUtility.o CryptoUtility.o Node.o VTree.o PTree.o DSAuth.o#Talk2Svr.o#auth_ds.o crypto_fhe_utility.o p_tree.o p_list.o v_tree.o v_list.o#MyDB.o
